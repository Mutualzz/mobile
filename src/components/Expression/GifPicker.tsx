...
export const GifPickerContent = observer(
    ({ active = true, onSelectGif }: GifPickerContentProps) => {
        ...
        const showTags = !search.trim() && !viewingFavorites;
        ...
        if (!listData.length && showTags) {
            return <View style={{ flex: 1 }}>{listHeader}</View>;
        }
                ...
                renderItem={({ item }) => (
                    <GifTile
                        ...
                        isFavorited={
                            ...
                            favoriteGifs.some((f) =>
                                f.startsWith(
                                    `https://klipy.com/gifs/${item.slug}`,
                                ),
                            )
                        }
