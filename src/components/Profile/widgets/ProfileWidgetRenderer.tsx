...
import { ProfileTextWidgetView } from "./blocks/ProfileTextWidgetView";
...
export function ProfileWidgetRenderer({ block, profile, user }: Props) {
  ...
  switch (block.type) {
    ...
    case "music":
      return (
        <ProfileMusicWidgetView block={block} size={size} profile={profile} />
      );
    case "links":
      return <ProfileLinksWidgetView block={block} size={size} />;
    case "activity":
      return (
        <ProfileActivityWidgetView block={block} size={size} userId={user.id} />
      );
    case "roles":
      return (
    ...
    case "mutual":
      return (
        <ProfileMutualWidgetView block={block} size={size} userId={user.id} />
      );
    case "divider":
