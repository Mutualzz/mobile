      ...
      >
        ...
        >
          ...
          >
            <Button
              ...
              color="neutral"
              variant="soft"
              onPress={() => navigate("/staff/reports")}
            >
              {t("nav.reports")}
            </Button>
            <Button
              ...
              color="neutral"
              variant="soft"
              onPress={() => navigate("/staff/activity")}
            >
              {t("nav.activity")}
            </Button>
            <Button
              ...
              color="neutral"
              variant="soft"
              onPress={() => navigate("/staff/appeals")}
            >
              {t("nav.appeals")}
            </Button>
            {app.account?.isDeveloper ? (
              <Button
                ...
                color="neutral"
                variant="soft"
                onPress={() => navigate("/staff/changelogs")}
              >
                {t("nav.changelogs")}
              </Button>
            ) : null}
        ...
        {isSnowflake && (
          <Pressable onPress={() => goToUser(trimmedQuery)}>
            <Paper variant="plain" style={{ padding: 12, borderRadius: 10 }}>
        ...
        <Box style={{ gap: 8 }}>
          {results.map((user) => (
            <Pressable key={user.id} onPress={() => goToUser(user.id)}>
              <Paper
                variant="plain"
                style={{
                  padding: 12,
